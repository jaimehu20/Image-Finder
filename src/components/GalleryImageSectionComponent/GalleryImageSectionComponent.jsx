...
export const GalleryImageSection = () => {
    ...
    if (favoriteList !== null) {
        const showPic = favoriteList.map((favImg, index) => {
            return (
                <div key={index} className='GalleryImageContainer'>
                    ...
                    <svg className="ImageContainerLike" onClick={() => dispatch(removeFavorite())}width="46" height="44" viewBox="0 0 46 44" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        return <>
            <div className='NoFavoritesFoundMessage'>
                <p>Oops! You dont have any favorite photos...</p>
            </div>
        </>
    }
