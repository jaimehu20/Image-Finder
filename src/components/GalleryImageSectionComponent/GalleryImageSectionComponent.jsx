        ...
        const showPic = photoFilter.map((favImg, index) => {
            return (
                <div key={index} className={!hidden[index] ? 'GalleryImageContainer' : 'GalleryImageContainerDisabled'}>
                    ...
                    <a href={favImg.url} target="_blank" className="ImageContainerDownload ImageContainerDownload--mod">
                        <svg className="ImageContainerDownloadIcon" width="47" height="46" viewBox="0 0 47 46" fill="none" xmlns="http://www.w3.org/2000/svg">
